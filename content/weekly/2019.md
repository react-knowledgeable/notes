...
- start promoting Dec events, i.e., tell people about:
  - [x] dec event date / JAMstack theme / proposal open
  - [ ] Stripe + venue (pending confirmation from Stripe, est. nov 14)
  - [ ] gatsby sponsorship
  - [ ] talks and speakers
- [x] follow up with Gatsby logistics (order placed, whether arrive or not is fingers crossed)
- [ ] follow up with JAMstack SG
- [ ] confirm talks
- pre event
  - [ ] send rsvp name list
